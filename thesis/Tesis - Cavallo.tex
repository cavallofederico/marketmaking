...
Se implementó la estimación de parámetros en base al trabajo de Cartea. Si bien no hay especificaciones implementativas se partió de la derivación de la estimación de máxima verosimilitud para este problema.
% Agregar matemática detrás del algoritmo de máxima verosimilitud tal cual está en el paper de Cartea, probablemente explicando salvedades y decisiones implementativas. Se puede ahondar en el juego de parametros y como cada uno impacta a la hora de estimar

%\section{Pseudo-código}
% Añadir linea por linea de forma genera elodigo para 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Acá se tiene que explicar la implementación mediante la cual se obtienen los parámetros. Lo que se tiene en el jupyter pero explicado correctamente, y se puede usar algún ejemplo.
